...
class PieOptions extends Component {
  ...
  componentDidMount() {
    let pizzaCost = 0
    // call api's
    axios.get('http://10.100.0.98:8888/api/sizes/').then((response) => {
      ...
      this.props.updateMain({
        pizzaCost: parseFloat(pizzaCost) * this.props.pizzaQuantity
      })

    }).catch((error) => {
      console.log(error);
    });
    axios.get('http://10.100.0.98:8888/api/crusts/').then((response) => {

      this.props.updateMain({pizzaCrustArray: response.data.results});
      this.props.updateMain({
        pizzaCrust: [
          response.data.results[0].name,
          parseFloat(response.data.results[0].price),
  ...
  _dropdown_Size_onSelect(idx, value) {
    this.props.updateMain({
      pizzaSize: [
        value,
        parseFloat(this.props.pizzaSizeArray[idx].price),
        this.props.pizzaSizeArray[idx].id
      ]
    });
  }
  _dropdown_Sauce_onSelect(idx, value) {
    this.props.updateMain({
      pizzaSauce: [
        value,
        parseFloat(this.props.pizzaSauceArray[idx].price),
        this.props.pizzaSauceArray[idx].id
      ]
    });
  }
  _dropdown_Crust_onSelect(idx, value) {
    this.props.updateMain({
      pizzaCrust: [
        value,
        parseFloat(this.props.pizzaCrustArray[idx].price),
        this.props.pizzaCrustArray[idx].id
      ]
    });
  }
    ...
    return (
      <View>
        ...
        <View style={styles.pieOptionRow}>
          ...
          <ModalDropdown style={styles.pieOptionDropdown} textStyle={styles.font15} adjustFrame={style => this._dropdown_1_adjustFrame(style)} defaultValue={this.props.pizzaQuantity.toString()} onSelect= {(idx, value)=> this._dropdown_Quantity_onSelect(idx,value)} options={this.props.pizzaQuantityArray}/>
        </View>
        <View style={styles.pieOptionRow}>
          <Text style={styles.optionTitle}>Size:</Text>

          <ModalDropdown style={styles.pieOptionDropdown} textStyle={styles.font15} adjustFrame={style => this._dropdown_1_adjustFrame(style)} defaultValue={this.props.pizzaSize[0]} onSelect= {(idx, value)=> this._dropdown_Size_onSelect(idx,value)} options={this.props.pizzaSizeNameArray}/>
        </View>
        <View style={styles.pieOptionRow}>
          <Text style={styles.optionTitle}>Sauce:</Text>

          <ModalDropdown style={styles.pieOptionDropdown} textStyle={styles.font15} adjustFrame={style => this._dropdown_1_adjustFrame(style)} defaultValue={this.props.pizzaSauce[0]} onSelect= {(idx, value)=> this._dropdown_Sauce_onSelect(idx,value)} options={this.props.pizzaSauceArray}/>
        </View>
        <View style={styles.pieOptionRow}>
          <Text style={styles.optionTitle}>Crust:
          </Text>

          <ModalDropdown style={styles.pieOptionDropdown} textStyle={styles.font15} adjustFrame={style => this._dropdown_1_adjustFrame(style)} defaultValue={this.props.pizzaCrust[0]} onSelect= {(idx, value)=> this._dropdown_Crust_onSelect(idx,value)} options={this.props.pizzaCrustNameArray}/>
